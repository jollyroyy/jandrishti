...
const assets = {
  seal: "/manus-storage/namma-civic-seal_1a426c61.png",
  hero: "/manus-storage/namma-hero-coast_2787efb0.jpg",
  pulse: "/manus-storage/namma-weekly-pulse_f3b683b8.jpg",
  road: "/manus-storage/namma-road-update_79fec2c6.jpg",
  water: "/manus-storage/namma-water-update_b743d677.jpg",
};
...
export default function Home() {
  ...
  const nav = (label: string) => { setActive(label); setMobileNavOpen(false); if (label !== "Home") toast(`${label} view selected`, { description: "The dashboard is filtered to this workspace." }); };
  ...
  return <div className="app-shell">
    ...
    <main className="main-area">
      ...
      <div className="content-grid">
        <section className="center-column">
          <section className="hero-card"><img src={assets.hero} alt="Mangaluru coastline at night" /><div className="hero-overlay"/><div className="hero-copy"><div className="eyebrow">MANGALURU · 204</div><h1>Your Area.<br/>Your Voice.<br/><span>Our Commitment.</span></h1><p>Let’s build a cleaner, smarter<br/>and stronger Mangaluru together.</p><div className="hero-actions"><Button className="report-button" onClick={report}>Report an Issue <Plus size={17}/></Button><Button variant="outline" className="projects-button" onClick={() => setProjectsOpen(true)}>See Projects <RouteIcon size={17}/></Button></div></div><div className="leaders"><div><strong>U.T. Khader</strong><span>MLA, Mangaluru</span></div><div><strong>Rahul Gandhi</strong><span>Leader of Opposition</span></div><div><strong>D.K. Shivakumar</strong><span>KPCC President</span></div><div><strong>Rajiv Gandhi</strong><span>Former Prime Minister</span></div></div></section>
    ...
    <Dialog open={projectsOpen} onOpenChange={setProjectsOpen}><DialogContent className="dark-dialog"><DialogHeader><DialogTitle>Projects across 204</DialogTitle><DialogDescription>Current work in the Mangaluru Assembly Constituency.</DialogDescription></DialogHeader><div className="project-items"><div><span className="status-chip green-chip">Completed</span><strong>Road improvement – Kotekar Main Road</strong><small>Updated today</small></div><div><span className="status-chip amber-chip">In progress</span><strong>Stormwater drainage renewal</strong><small>Expected completion: June 2024</small></div><div><span className="status-chip blue-chip">Planning</span><strong>Community water resilience plan</strong><small>12 localities included</small></div></div></DialogContent></Dialog>
